...
class Analyse_Grayscale(object):
    ...
    def __init__(self, type="Kodak", image=None, scale_factor=1.0, dpi=600):
        ...
        self._grayscale_dict = {
            'Kodak': {
                'aims': [82, 78, 74, 70, 66, 62, 58, 54, 50, 46, 42,
        ...
        self._grayscale_aims = self._grayscale_dict[
                            self.grayscale_type]['aims']

        self._grayscale_sections = self._grayscale_dict[
                            self.grayscale_type]['sections']

        self._grayscale_width = self._grayscale_dict[
                            self.grayscale_type]['width']
    ...
    def get_grayscale(self, image=None, scale_factor=1.0, dpi=600):
        ...
        #Paralell trim - right
        box_need = self._grayscale_dict['Kodak']['lower-than-half-width'] / \
                                                scale_factor
        ...
        box_need = self._grayscale_dict['Kodak']['higher-than-half-width'] / \
                                 scale_factor
        ...
        self.ortho_half_height = self._grayscale_dict['Kodak']['width'] / \
            2.0 * safety_coeff
        ...
        #plt.plot(
            #np.arange(self._grayscale_dict['Kodak']['sections']+2)
            #*frequency+offset+rect[0][0],
            #np.ones(self._grayscale_dict['Kodak']['sections']+2)
