...
class Fixture_Settings(object):
    ...
    def __init__(self, fixture_config_root, fixture="fixture_a", image=None,
                                marking=None, markings=-1):
    ...
    def set_areas_positions(self, X=None, Y=None):
        ...
        if ref_gs != None and bool(self.fixture_config_file.get(
                                "grayscale")) == True:
        ...
        while ref_m != None:
            ...
            if ref_m != None:
                ...
                self.current_analysis_image_config.set(
                    "plate_" + str(i) + "_area",
