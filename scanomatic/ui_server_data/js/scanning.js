...
var API = function () {
    ...
    _createClass(API, null, [{
            ...
            return new Promise(function (resolve, reject) {
                return $.ajax({
                    ...
                    error: function error(jqXHR) {
                        return reject(JSON.parse(jqXHR.responseText).reason);
                    }
                });
            });
        }
        ...
        key: 'postJSON',
        value: function postJSON(url, json) {
            return new Promise(function (resolve, reject) {
                return $.ajax({
                    url: url,
                    type: 'POST',
...
var _RootContainer = __webpack_require__(74);
...
$(document).ready(function () {
    _reactDom2.default.render(_react2.default.createElement(_RootContainer2.default, null), document.getElementById('react-root'));
});
...
var RootContainer = function (_React$Component) {
    ...
    function RootContainer(props) {
        ...
        _this.handleCloseNewJob = _this.handleCloseNewJob.bind(_this);
        return _this;
    }

    _createClass(RootContainer, [{
        key: 'handleNewJob',
        value: function handleNewJob() {
            this.setState({ newJob: true });
        }
    }, {
        key: 'handleCloseNewJob',
        value: function handleCloseNewJob() {
...
var _NewJobContainer = __webpack_require__(76);

var _NewJobContainer2 = _interopRequireDefault(_NewJobContainer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function Root(props) {
    var newJob = props.newJob ? _react2.default.createElement(_NewJobContainer2.default, { onClose: props.onCloseNewJob }) : null;
...
Root.propTypes = {
    ...
    newJob: _propTypes2.default.bool.isRequired,
    onNewJob: _propTypes2.default.func.isRequired,
    onCloseNewJob: _propTypes2.default.func.isRequired
};
...
var _NewJob = __webpack_require__(77);
...
var NewJobContainer = function (_React$Component) {
    _inherits(NewJobContainer, _React$Component);

    function NewJobContainer(props) {
        _classCallCheck(this, NewJobContainer);

        var _this = _possibleConstructorReturn(this, (NewJobContainer.__proto__ || Object.getPrototypeOf(NewJobContainer)).call(this, props));
        ...
        _this.handleDurationDaysChange = _this.handleDurationDaysChange.bind(_this);
        _this.handleDurationHoursChange = _this.handleDurationHoursChange.bind(_this);
        _this.handleDurationMinutesChange = _this.handleDurationMinutesChange.bind(_this);
        _this.handleIntervalChange = _this.handleIntervalChange.bind(_this);
    ...
    _createClass(NewJobContainer, [{
        ...
        key: 'handleDurationDaysChange',
        value: function handleDurationDaysChange(e) {
            var days = Number(Number(e.target.value).toFixed(0));
            if (days < 0) {
                days = 0;
            }
            var duration = Object.assign({}, this.state.duration);
            duration.days = days;
            this.setState({ duration: duration });
        }
    }, {
        key: 'handleDurationHoursChange',
        value: function handleDurationHoursChange(e) {
            var hours = Number(Number(e.target.value).toFixed(0));
            var days = this.state.duration.days;
        ...
        key: 'handleDurationMinutesChange',
        value: function handleDurationMinutesChange(e) {
            var minutes = Number(Number(e.target.value).toFixed(0));
            var _state$duration = this.state.duration,
                days = _state$duration.days,
                hours = _state$duration.hours;
            ...
            this.setState({ duration: { days: days, hours: hours, minutes: minutes } });
        }
    }, {
        key: 'handleIntervalChange',
        value: function handleIntervalChange(e) {
            var minutes = Number(Number(e.target.value));
            if (minutes < 5) {
                minutes = 5;
            }
        ...
        value: function handleSumbit() {
            ...
            }).then(this.props.onClose).catch(function (reason) {
                return _this2.setState({ error: 'Error submitting job: ' + reason });
            });
        }
    }, {
        key: 'render',
...
exports.default = NewJobContainer;
...
NewJob.propTypes = {
    ...
    onDurationDaysChange: _propTypes2.default.func.isRequired,
